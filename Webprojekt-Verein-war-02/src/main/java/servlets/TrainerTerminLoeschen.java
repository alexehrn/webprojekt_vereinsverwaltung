 ...
 */
@WebServlet("/TrainerTerminLoeschen")
public class TrainerTerminLoeschen extends HttpServlet {
	...
	private void delete(Long id) throws ServletException {
		...
		try (Connection con = ds.getConnection();
			 PreparedStatement pstmt = con.prepareStatement("DELETE FROM termine WHERE termin_id = ?")){
			pstmt.setLong(1, id);
			pstmt.executeUpdate();
		} catch (Exception ex) {
